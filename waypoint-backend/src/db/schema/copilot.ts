...
// The copilot_proposals table (and its copilot_proposal_kind /
// copilot_proposal_status enums) moved to ./proposals.ts and was renamed to
// `proposals` (P3 W3.1 — see docs/design/waypoint-revamp-architecture.md
// §4.2): a proposal is no longer necessarily copilot-scoped, so it no
