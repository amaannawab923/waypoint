 ...
 *  4. The on-screen copy is a contract. "one API call · refresh to re-read"
 *     was written deliberately to replace a false "polls every 15s"; a
 *     toolbar that quietly issued a request per interaction would make it
 *     false again.
 *
