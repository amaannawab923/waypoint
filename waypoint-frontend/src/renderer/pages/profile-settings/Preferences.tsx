...
export default function Preferences() {
  ...
  return (
    <div className="max-w-lg">
      <h2 className="mb-6 font-display text-lg font-medium text-text">Preferences</h2>
      ...
      <div className="flex flex-col gap-5">
        <div>
          ...
          <input id="timezone" className={selectClass} value="UTC" disabled readOnly />
        </div>
        ...
        <div>
          ...
          <input id="language" className={selectClass} value="English" disabled readOnly />
        </div>
